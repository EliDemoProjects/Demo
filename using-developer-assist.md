...
When using Developer Assist in **VS Code** with **GitHub Copilot**, there is a known issue that each time that you call the Checkmarx MCP, the `mcp.json` file automatically opens in your workspace.
