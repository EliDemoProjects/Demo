...
2.  When Checkmarx realtime scanners identify a risk, it is flagged as a **Problem**, which is marked in the code with a squiggly underline and annotated in the margin with an icon that indicates the type of risk.
    ...
    ![vulnerability2.png](../.gitbook/assets/img-4f3f94be7ca1c8f0ce2b8faccbe8d496.png)
3.  Hover over the vulnerable line of code.

    The Checkmarx dialog opens.

    ![dialog2.png](../.gitbook/assets/img-d896b154664bf2bfe2fdd4594c952435.png)
4.  Click on **Fix with Checkmarx Developer Assist**.

    ![fixjetbrains.png](../.gitbook/assets/img-c44e70f4834374a710812e32c758bdbb.png)

    A Copilot session opens in the side panel and all relevant info is sent for analysis.

    <div data-gb-custom-block data-tag="hint" data-style="info" data-icon="pencil" class="hint hint-info"><p>Depending on your IDE configuration, you may need to click <strong>Continue</strong> several times in order to complete the process.</p></div>
5.  Copilot automatically makes the necessary changes in the code in order to remediate the risk.

    ![acceptall.png](../.gitbook/assets/img-d2088e3d0874c3b51abeafbbd7f04a71.png)
...
<div align="left"><img src="../.gitbook/assets/img-7c4a2407cf99756d42fbe12660d6f9ce.png" alt="findings2.png" width="563"></div>
...
3.  Click on **View details**.
    ...
    ![viewdetails.png](../.gitbook/assets/img-638b072f4e89de112ca36a27fc9d63e1.png)
...
1.  Click on the **Ignored Findings** tab in the Checkmarx window.
    ...
    <div align="left"><img src="../.gitbook/assets/img-02475afec7b97d2db724130403743d6d.png" alt="findings3.png" width="563"></div>
