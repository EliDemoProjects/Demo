...
This page shows tutorial videos demonstrating the end-to-end flow of setting up and using the Checkmarx Developer Assist extension. There is a separate video for each of the supported IDEs that can use this extension, VS Code, Cursor, Windsurf and Kiro.

Each video shows the following steps:
